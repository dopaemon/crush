...
func NewServer(cfg *config.ConfigStore, network, address string) *Server {
	...
	mux.HandleFunc("GET /v1/workspaces/{id}/sessions/{sid}/goal", c.handleGetWorkspaceSessionGoal)
	mux.HandleFunc("PUT /v1/workspaces/{id}/sessions/{sid}/goal", c.handlePutWorkspaceSessionGoal)
	mux.HandleFunc("DELETE /v1/workspaces/{id}/sessions/{sid}/goal", c.handleDeleteWorkspaceSessionGoal)
	mux.HandleFunc("GET /v1/workspaces/{id}/thread/goal/get", c.handleGetWorkspaceThreadGoal)
	mux.HandleFunc("POST /v1/workspaces/{id}/thread/goal/set", c.handlePostWorkspaceThreadGoalSet)
	mux.HandleFunc("POST /v1/workspaces/{id}/thread/goal/clear", c.handlePostWorkspaceThreadGoalClear)
